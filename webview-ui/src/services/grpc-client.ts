...
export class RemoteServiceClient extends ProtoBusClient {
	static override serviceName: string = "cline.RemoteService"
    static async getRemoteStatus(request: proto.cline.EmptyRequest): Promise<proto.cline.RemoteStatus> {
		return this.makeUnaryRequest("getRemoteStatus", request, proto.cline.EmptyRequest.toJSON, proto.cline.RemoteStatus.fromJSON)
	}
    static async setRemoteEnabled(request: proto.cline.BooleanRequest): Promise<proto.cline.RemoteStatus> {
		return this.makeUnaryRequest("setRemoteEnabled", request, proto.cline.BooleanRequest.toJSON, proto.cline.RemoteStatus.fromJSON)
	}
    static async getPairingInfo(request: proto.cline.EmptyRequest): Promise<proto.cline.PairingInfo> {
		return this.makeUnaryRequest("getPairingInfo", request, proto.cline.EmptyRequest.toJSON, proto.cline.PairingInfo.fromJSON)
	}
    static async setSignalingUrl(request: proto.cline.StringRequest): Promise<proto.cline.RemoteStatus> {
		return this.makeUnaryRequest("setSignalingUrl", request, proto.cline.StringRequest.toJSON, proto.cline.RemoteStatus.fromJSON)
	}
    static async regenerateSharedKey(request: proto.cline.EmptyRequest): Promise<proto.cline.PairingInfo> {
		return this.makeUnaryRequest("regenerateSharedKey", request, proto.cline.EmptyRequest.toJSON, proto.cline.PairingInfo.fromJSON)
	}
}
